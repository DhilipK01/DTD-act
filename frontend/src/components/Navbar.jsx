      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <div className="relative" ref={themeMenuRef}>
            ...
            {themeMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 py-2 bg-slate-900/95 border border-white/15 rounded-2xl shadow-2xl backdrop-blur-xl z-50 animate-in fade-in zoom-in-95 duration-150">
                ...
                {themes.map((t) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <span className={`w-3 h-3 rounded-full ${t.dot} shadow-sm`} />
                      <span>{t.name}</span>
                    </div>
